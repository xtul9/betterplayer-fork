class LocaleParser {
  ...
  static final Map<String, Map<String, String>> _isoLanguages = {
  ...
  static Language? getDisplayLanguage(String languageCode) {
    String lowercaseCode = languageCode.toLowerCase();
    if (_isoLanguages.containsKey(lowercaseCode)) {
      final Map<String, String> languageDetails = _isoLanguages[lowercaseCode]!;
      final String englishName = languageDetails["name"]!;
      final String nativeName = languageDetails["nativeName"]!;
      return Language(lowercaseCode, englishName, nativeName);
    } else {
      return null;
    }
  }
...
class Language {
  ...
  Language(this.languageCode, this.englishName, this.nativeName);
}
